...
%%
%% ! 2017 - yutopp CHANGED this source code.
%% - Module name is changed.
%% - Some parsing rules are added.
%%
%% %CopyrightEnd%
%%
...
function_clause -> atom clause_args clause_guard clause_body :
	{clause,?anno('$1'),element(3, '$1'),'$2','$3',{return_type, undefined},'$4'}.
function_clause -> atom clause_args clause_guard '::' top_type clause_body :
	{clause,?anno('$1'),element(3, '$1'),'$2','$3',{return_type, '$5'},'$6'}.

clause_args -> parameter_list : element(1, '$1').
...
parameter_list -> '(' ')' : {[],?anno('$1')}.
parameter_list -> '(' params ')' : {'$2',?anno('$1')}.
...
Header
"%% This file was automatically generated from the file \"tylang_parse.yrl\"."
"%%"
...
check_clauses(Cs, Name, Arity) ->
    [case C of
         {clause, A, N, As, RetTy, G, B} when N =:= Name, length(As) =:= Arity ->
             {clause, A, As, RetTy, G, B};
         {clause, A, _N, _As, _RetTy, _G, _B} ->
...
-type tylang_parse_tree() :: abstract_clause()
                         | abstract_expr()
                         | abstract_form()
                         | abstract_type().
...
-spec map_anno(Fun, Abstr) -> NewAbstr when
      ...
      Abstr :: tylang_parse_tree() | form_info(),
      NewAbstr :: tylang_parse_tree() | form_info().
...
-spec anno_from_term(Term) -> tylang_parse_tree() | form_info() when
      Term :: term().
